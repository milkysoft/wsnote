    ...
    Next:{
     ...
     Attr:Runtime.Class({},{
      ...
      Value:function(_var)
      {
       ...
       onChange=function(e)
       {
        return!Unchecked.Equals(e.currentTarget.value,_var.get_Value())?Var.Set(_var,e.currentTarget.value):null;
       };
     ...
     Doc:Runtime.Class({
      ...
      InputInternal:function(attr,_var,inputTy)
      {
       ...
       patternInput=inputTy.$==1?[Attr.Append(Attr.Create("type",inputTy.$0),Attr.Concat(attr)),"input"]:inputTy.$==2?[Attr.Concat(attr),"textarea"]:[Attr.Concat(attr),"input"];
